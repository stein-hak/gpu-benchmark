...
NVENC settings optimized for maximum parallel capacity and low latency:
...
class StreamEncoder:
    ...
    def run(self):
        ...
        pipeline_str = (
            ...
            "! nvh264enc preset=low-latency-hp zerolatency=true rc-mode=cbr bitrate=5000 gop-size=60 "
